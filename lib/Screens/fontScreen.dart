        ...
        children: <Widget>[
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "Please select your desired font from the list of fonts provided.",
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              print(UpdateverifiedCheck);
                              print(checkBackColor);
                              print(backGroudColor);
                              print(sendColorrr1);
                              print(sendColorrr2);
                              print(sendColorrr3);
                              print(UpdatetextColor);
                              print(socialColorGlobal);
                              print(UpdateEmail);
                              print(UpdateTelephone);
                              print(UpdateTelegram);
                              print(UpdateWhatsApp);
                              print(UpdateFacebook);

                              print(UpdateFacebookMessenger);

                              print(UpdateInstagram);
                              ...
                              print(UpdateYoutube);
                              print(UpdateSoundCloud);
                              print(UpdateLinkdin);
                              print(UpdateSpotify);
                              print(UpdatePinterest);
                              print(FontGlobal);
          ...
          String sendColorrr3Api = sendColorrr33
              ...
              .substring(0, sendColorrr33.toString().length - 1);
                                            ...
                                            print(SocialColorrApi);
              print(UpdatetextColorApi);
