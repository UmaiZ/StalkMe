...
class _titleScreenState extends State<titleScreen> {
  ...
  final TextEditingController userTitle = new TextEditingController();
  String accestoken = accessTokenGlobal;

    @override
  void initState() {
    super.initState();
    userTitle.text = UpdateTitle;
      ...
      body: Column(
        children: <Widget>[
          ...
          String UpdatetextColorApi = UpdatetextColorrr
              ...
              print('ya color ha ${sendColorrr1}');
          ...
          String sendColorrr1Api = sendColorrr11
              ...
              print('ya color ja rha ha  ${sendColorrr1Api}');
